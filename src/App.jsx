...
function App({ variant, showAccounts, gallery: galleryType }) {
  const [initialViewportHeight] = useState(() => window.visualViewport?.height ?? window.innerHeight);
  ...
  return (
    <main className={`design-${variant}`} style={{ '--hero-viewport-height': `${initialViewportHeight}px` }}>
      <section className="hero">
        ...
        <p className="hero-event-info" aria-label="예식 일시 및 장소">2026.10.10 <span>·</span> 12:30 PM <span>·</span> 타니베이 호텔</p>
